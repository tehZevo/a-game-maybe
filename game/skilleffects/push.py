from game.components.physics import Position, Physics
...
class Push(SkillEffect):
  ...
  def start(self):
    ...
    effect_pos = self.parent.get_component(Position).pos
    ...
    self.target.get_component(Physics).apply_force(dir * force)
